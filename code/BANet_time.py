...
def build_model():
    ...
    lstm_units = 8
    LSTM1 = LSTM(lstm_units, return_sequences=True, implementation=1)(singleinput) # Refer to https://www.tensorflow.org/api_docs/python/tf/keras/layers/LSTM to decide if 'CuDNN' is needed.
    ...
    # Model 3: Feature Concatenation for classification
    ...
    finalresult = Flatten()(DATA)
    output = Dense(2, activation='softmax')(finalresult)
